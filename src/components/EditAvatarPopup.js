...
function EditAvatarPopup(props){
    ...
    return(
        <PopupWithForm handleSubmit={handleSubmit} name="picture-change" title="Change profile picture" buttonText="Save" isOpen={props.isOpen} onClose={props.onClose}>
           <input required id="avatar" onChange={handleAvatarChange} name="avatar" placeholder="URL" ref={avatarInputRef} className="popout__form-input popout__form-input_type_avatar" type="url" />
